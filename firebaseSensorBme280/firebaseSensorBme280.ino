// ESTO ES PARA LA CONEXION A INTERNET
#include <WiFi.h>

// ESTO ES PARA EL FIREBASE
...
// URL DE LA BASE DE DATOS DE FIRESTOREDATABSE DE FIREBASE
// #define DATABASE_URL "esp-firebase-demo-cc274.firebaseapp.com"
...
void sendFloat(String path, float value) {
  ...
  String newPath = databasePath + "/" + path + "/" + uniqueKey;
  if (Firebase.RTDB.setFloat(&fbdo, newPath.c_str(), value)) {
    Serial.println("-----------------------------------------------------------------------------------------------------------------");
...
void setup() {
  ...
  tempPath = "TEMPERATURA";  // --> UsersData/<user_uid>/temperature
  humPath = "HUMEDAD";       // --> UsersData/<user_uid>/humidity
  presPath = "PRESION";      // --> UsersData/<user_uid>/pressure
}
